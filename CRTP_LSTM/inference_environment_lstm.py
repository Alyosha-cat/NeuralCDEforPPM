...
class BatchInference():
    ...
    def compute_ttne_results(self):
        ...
        self.ttne_preds_stand = self.convert_to_transf(time_string='ttne', input_tensor=self.ttne_preds_seconds)
        ...
        MAE_ttne_stand = torch.abs(self.ttne_preds_stand - self.ttne_labels) # (batch_size, window_size)
        MAE_ttne_stand = MAE_ttne_stand[before_end_token] # shape (torch.sum(self.actual_length+1), )

        return MAE_ttne_seconds, MAE_ttne_stand
