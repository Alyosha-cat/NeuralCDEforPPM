...
class BatchInference():
    ...
    def compute_rrt_results(self):
        ...
        abs_errors = torch.abs(self.convert_to_transf(time_string='rrt', input_tensor=self.rrt_sum_seconds) - self.rrt_labels)
        return abs_errors, abs_errors_sum # both (batch_size,)
