...
class BatchInference():
    ...
    def compute_rrt_results(self):
        ...
        abs_errors_sum_stand = torch.abs(self.convert_to_transf(time_string='rrt', input_tensor=self.rrt_sum_seconds) - self.rrt_labels) # (num_prefs,)
        return abs_errors_sum_stand, abs_errors_sum # (num_prefs,)
